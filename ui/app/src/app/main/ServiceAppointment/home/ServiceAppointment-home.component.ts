...
@Component({
  selector: 'ServiceAppointment-home',
  templateUrl: './ServiceAppointment-home.component.html',
  styleUrls: ['./ServiceAppointment-home.component.scss']
})
export class ServiceAppointmentHomeComponent implements AfterViewInit {
