...
@Component({
  selector: 'ServiceTechnician-home',
  templateUrl: './ServiceTechnician-home.component.html',
  styleUrls: ['./ServiceTechnician-home.component.scss']
})
export class ServiceTechnicianHomeComponent implements AfterViewInit {
