...
resourcename="otto4"  # lower case, only
resourcegroup="otto4_rg"
...
# git clone https://github.com/apilogicserver/otto4.git
# cd otto4
...
az group create --name otto4_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group otto4_rg --sku S1 --is-linux
az container create --resource-group otto4_rg --name otto4 --image apilogicserver/otto4:latest --dns-name-label otto4 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//otto4.westus.azurecontainer.io:5656'
